...
dependencies {
    implementation 'com.applanga.android:Applanga:4.0.198'
}
```
...
plugins {
    ...
    id 'com.applanga.gradle' version '4.0.198'
}
```
...
buildscript {
    ...
    dependencies {
        classpath  'com.applanga.gradle:plugin:4.0.198'
    }
}
```
...
If your project is a branching project use at least SDK version 4.0.198 and update your settings file.
