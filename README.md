...
dependencies {
    implementation 'com.applanga.android:Applanga:4.0.199'
}
```
...
plugins {
    ...
    id 'com.applanga.gradle' version '4.0.199'
}
```
...
buildscript {
    ...
    dependencies {
        classpath  'com.applanga.gradle:plugin:4.0.199'
    }
}
```
...
If your project is a branching project use at least SDK version 4.0.199 and update your settings file.
