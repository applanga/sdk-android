...
dependencies {
    implementation 'com.applanga.android:Applanga:4.0.196'
}
```
...
plugins {
    ...
    id 'com.applanga.gradle' version '4.0.196'
}
```
...
buildscript {
    ...
    dependencies {
        classpath  'com.applanga.gradle:plugin:4.0.196'
    }
}
```
...
If your project is a branching project use at least SDK version 4.0.196 and update your settings file.
