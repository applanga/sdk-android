...
dependencies {
    implementation 'com.applanga.android:Applanga:4.0.221'
}
```
...
plugins {
    ...
    id 'com.applanga.gradle' version '4.0.221'
}
```
...
buildscript {
    ...
    dependencies {
        classpath  'com.applanga.gradle:plugin:4.0.221'
    }
}
```
